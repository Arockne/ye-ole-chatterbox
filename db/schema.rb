...
ActiveRecord::Schema.define(version: 2022_01_11_172840) do
  ...
  create_table "communications", force: :cascade do |t|
    t.text "message"
    t.bigint "chatroom_membership_id", null: false
    t.bigint "chatroom_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["chatroom_id"], name: "index_communications_on_chatroom_id"
    t.index ["chatroom_membership_id"], name: "index_communications_on_chatroom_membership_id"
  end
  ...
  add_foreign_key "communications", "chatroom_memberships"
